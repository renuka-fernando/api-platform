...
// CreateLLMProxyAPIKeyRequest represents the request to create an API key for an LLM proxy.
type CreateLLMProxyAPIKeyRequest struct {
	// Name is the unique identifier for this API key within the LLM proxy
...
// CreateLLMProxyAPIKeyResponse represents the response after creating an API key for an LLM proxy.
